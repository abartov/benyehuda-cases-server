...
ActiveRecord::Schema.define(version: 20_251_227_212_355) do
  ...
  create_table 'audits', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_audits_on_user_id_and_created_at'
  end
  ...
  create_table 'comments', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.index %w[task_id created_at editor_eyes_only], name: 'task_created_eyes'
  ...
  create_table 'custom_properties', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[proprietary_id proprietary_type], name: 'proprietary'
  end
  ...
  create_table 'documents', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.index %w[user_id created_at], name: 'index_documents_on_user_id_and_created_at'
  end
  ...
  create_table 'search_settings', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[user_id search_key], name: 'index_search_settings_on_user_id_and_search_key'
  end
  ...
  create_table 'site_notices', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[start_displaying_at end_displaying_at],
            name: 'index_site_notices_on_start_displaying_at_and_end_displaying_at'
  end
  ...
  create_table 'translation_texts', id: :integer, charset: 'utf8mb3', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[translation_key_id locale], name: 'index_translation_texts_on_translation_key_id_and_locale',
                                           unique: true
  end
