...
# Don't override the default behavior of rails form_with.
# Rails.application.config.action_view.form_with_generates_remote_forms = false

# Change the default variant processor from :mini_magick to :vips.
# Rails.application.config.active_storage.variant_processor = :vips

# Disable partial inserts. This is recommended for production environments only.
