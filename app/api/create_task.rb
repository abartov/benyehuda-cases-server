class CreateTask < Grape::API
  ...
  namespace :create_task do
    ...
    params do
      ...
      optional :full_nikkud, type: String,
                             desc: 'is the text with full-nikkud (diacritics), e.g. poetry, children' + 's prose. ("true" or "false")'
    end
    ...
    post do
      ...
      if tasks_user.blank? || !tasks_user.admin_or_editor?
